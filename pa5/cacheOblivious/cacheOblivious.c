...
void recursiveMatTrans (
    ...
    if (n<=4) { // base case
        ...
        size_t half = n/2;
        recursiveMatTrans(global_n, half, A, offset_row_A, offset_col_A, B, offset_row_B, offset_col_B);
        recursiveMatTrans(global_n, half, A, offset_row_A, offset_col_A + half, B, offset_row_B + half, offset_col_B);
        recursiveMatTrans(global_n, half, A, offset_row_A + half, offset_col_A, B, offset_row_B, offset_col_B + half);
        recursiveMatTrans(global_n, half, A, offset_row_A + half, offset_col_A + half, B, offset_row_B + half, offset_col_B + half);
    }
}
